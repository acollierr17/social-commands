 ...
 */
public class CmdSnapchat implements CommandExecutor {

    private MySocialcommands main;
    private ConfigUtils configutils = new ConfigUtils();

    public CmdSnapchat(MySocialcommands main) {
        this.main = main;
    }
    ...
    public boolean onCommand(CommandSender sender, Command cmd, String commandLabel, String[] args) {
        ...
        String snapchat = configutils.getStringMessages().getString("snapchat");
        ...
        sender.sendMessage(ChatColor.GOLD + ChatColor.translateAlternateColorCodes('&', prefixcolor + "Snapchat » ") + (ChatColor.GRAY + ChatColor.translateAlternateColorCodes('&', color + snapchat)));
