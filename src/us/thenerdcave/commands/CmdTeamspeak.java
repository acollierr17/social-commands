...
public class CmdTeamspeak implements CommandExecutor {
    ...
    public CmdTeamspeak(MySocialcommands main) {
        this.main = main;
    }
    ...
    public boolean onCommand(CommandSender sender, Command cmd, String commandLabel, String[] args) {
        ...
        String teamspeak = configutils.getStringMessages().getString("teamspeak");
        ...
        sender.sendMessage(ChatColor.GOLD + ChatColor.translateAlternateColorCodes('&', prefixcolor + "TeamSpeak » ") + (ChatColor.GRAY + ChatColor.translateAlternateColorCodes('&', color + teamspeak)));
