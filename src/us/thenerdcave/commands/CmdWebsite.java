...
public class CmdWebsite implements CommandExecutor {
    ...
    public CmdWebsite(MySocialcommands main) {
        this.main = main;
    }
    ...
    public boolean onCommand(CommandSender sender, Command cmd, String commandLabel, String[] args) {
        ...
        String website = configutils.getStringMessages().getString("website");
        ...
        sender.sendMessage(ChatColor.GOLD + ChatColor.translateAlternateColorCodes('&', prefixcolor + "Website » ") + (ChatColor.GRAY + ChatColor.translateAlternateColorCodes('&', color + website)));
